...
variable "ecs_service_subnet_ids" {
  ...
  type        = list(string)
  default     = ["subnet-0952fdb8485c0b6b6","subnet-0c0d14c51b93184d3"]
}
...
variable "lb_subnet_ids" {
  ...
  type        = list(string)
  default     = ["subnet-0fc4d746d16be471a","subnet-0d0e758530a59600f"]
}
...
variable "db_subnet_group_subnet_ids" {
  ...
  type        = list(string)
  default     = ["subnet-0e668f27252877b4c","subnet-0bb1b4d282491d7b5"]
}
